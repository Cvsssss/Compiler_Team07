...
class CodeAnalyzerApp:
    def __init__(self, root):
        ...
        self.text_area_input = ttk.Text(self.left_panel, height=15, font=("Consolas", 12), bg="#fafafa", fg="black", relief="flat", highlightthickness=1, highlightbackground="#cccccc")
        ...
        self.text_area_output = ttk.Text(self.right_panel, height=15, font=("Consolas", 12), state="disabled", bg="#fafafa", fg="black", relief="flat", highlightthickness=1, highlightbackground="#cccccc")
...
if __name__ == "__main__":
    root = ttk.Window(themename="flatly")  # Tema inicial
